...
POSTGRES_READ_DSN = getenv("POSTGRES_READ_DSN", "postgresql://postgres:Tunners07DB@127.0.0.1:5432/hermes")
POSTGRES_WRITE_DSN = getenv("POSTGRES_WRITE_DSN", "postgresql://postgres:Tunners07DB@127.0.0.1:5432/hermes")
